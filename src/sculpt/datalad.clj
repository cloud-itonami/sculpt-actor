...
(defn ->isekai-manifest
  ...
  {:asset/id id
   ...
   :asset/format format
   :asset/title title
   :asset/author "gftd-sculpt-actor"
   :asset/license license
   :asset/tags (vec tags)
   :asset/source :gen
   :asset/gen {:stage :photo-to-3d :job-key gen-job-id :prompt prompt
               :provenance "murakumo/trellis via gftd-sculpt-actor co-scientist loop"}

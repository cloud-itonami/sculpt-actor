(ns sculpt.loop-test
  "Full tick! cycle, fully offline: sculpt.murakumo/sculpt.judge/datalad shell
...
(defn- tmp-dir []
  (let [f (java.io.File/createTempFile "sculpt-loop-test" "")]
    (.delete f) (.mkdirs f) f))
